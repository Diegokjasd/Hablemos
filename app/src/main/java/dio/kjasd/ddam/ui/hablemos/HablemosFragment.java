...
public class HablemosFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        // nota de Diego xd inicializacion TextToSpeech dentro de OnCreate, usamos getActivity al ser fragment, usualmente se usa (this) en Activity
        ...
        mButtonSpeak.setOnClickListener(new  View.OnClickListener(){
            ...
            private void speak(){
                ...
                if (tono < 0.1) tono = 0.1f; //f por que lo casteamos como float
